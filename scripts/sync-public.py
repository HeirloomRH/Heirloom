#!/usr/bin/env python3
"""
Heirloom Public Repo Sync Script
=================================
Syncs the local `main` branch to the public Open Source repository (heirloomrh/heirloom)
while rewriting all commit authors & committers to:
  HeirloomRH <weegleweegletech26@gmail.com>
...
File contents are scrubbed of secret-shaped test fixtures.

Keeps the primary `origin` (notadeveloper7/heirloom) untouched for Lovable & deployment compatibility.
"""
...
PUBLIC_AUTHOR_NAME = "HeirloomRH"
PUBLIC_AUTHOR_EMAIL = "weegleweegletech26@gmail.com"
REMOTE_PUBLIC = "public-origin"
TARGET_BRANCH = "main"
...
# Secret-shaped strings replaced in file contents on the way to the public mirror.
SECRET_PATTERNS = (
